	...
	if       => {
		...
		arbit => {
			"Additional details" => {
				...
				"5" => 'The second string (if present) will be a number, optionally preceeded by the word "series" or "path" (meaning that it is pointing to a single element, an element series, or an element path)',
	...
	choice   => {
		...
		arbit  => {
			"Additional details" => {
				...
				"7" => 'The third string (if present) will be a number, optionally preceeded by the word "series" or "path" (meaning that it is pointing to a single element, an element series, or an element path)',
